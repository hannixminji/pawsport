...
GCS_BUCKET="${GCS_BUCKET:-pawsport-thesis}"
...
create_placeholder "BREVO_API_KEY"
...
echo ""
echo -e "  ${YELLOW}Note: GCP_PROJECT_ID, BREVO_SENDER_EMAIL, BREVO_SENDER_NAME and GCS_BUCKET_NAME are GitHub Variables (not secrets).${RESET}"
