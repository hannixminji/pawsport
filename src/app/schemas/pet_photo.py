...
class PetPhotoBase(BaseModel):
    object_key: Annotated[str, Field(min_length=1, max_length=1024, examples=["path/to/photo.jpg"])]
...
class PetPhoto(TimestampSchema, PetPhotoBase, PersistentDeletion):
    pet_id: int
...
class PetPhotoUpdate(BaseModel):
    ...
    def validate_existing_or_new_photo(self):
