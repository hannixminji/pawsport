...
async def search_pet_allergies(
    ...
    actor: Annotated[Actor, Depends(require_permission("pet_allergy:search"))],
...
async def list_pet_allergies(
    request: Request,
    actor: Annotated[Actor, Depends(require_permission("pet_allergy:read"))],
    service: PetAllergyServiceDependency,
...
async def bulk_soft_delete_pet_allergies(
    ...
    actor: Annotated[Actor, Depends(require_permission("pet_allergy:bulk_soft_delete"))],
    service: PetAllergyServiceDependency,
) -> None:
...
async def soft_delete_pet_allergy(
    request: Request,
    allergy_id: int,
    actor: Annotated[Actor, Depends(require_permission("pet_allergy:soft_delete"))],
    service: PetAllergyServiceDependency,
) -> None:
...
async def update_pet_allergy(
    ...
    actor: Annotated[Actor, Depends(require_permission("pet_allergy:update"))],
    service: PetAllergyServiceDependency,
) -> None:
