...
Revision ID: cc2974b59dd2
Revises: 
Create Date: 2026-03-04 08:42:19.618211
...
def upgrade() -> None:
    ...
    op.drop_geospatial_index(op.f('tiger_faces_the_geom_gist'), table_name='faces', schema='tiger', postgresql_using='gist', column_name='the_geom')
    op.drop_geospatial_table('faces', schema='tiger')
    op.drop_geospatial_index(op.f('tiger_place_the_geom_gist'), table_name='place', schema='tiger', postgresql_using='gist', column_name='the_geom')
    op.drop_geospatial_table('place', schema='tiger')
    op.drop_table('pagc_lex')
    op.drop_geospatial_index(op.f('tige_cousub_the_geom_gist'), table_name='cousub', schema='tiger', postgresql_using='gist', column_name='the_geom')
    op.drop_geospatial_table('cousub', schema='tiger')
    ...
    op.drop_geospatial_table('tract', schema='tiger')
    ...
    op.drop_geospatial_index(op.f('idx_tiger_state_the_geom_gist'), table_name='state', schema='tiger', postgresql_using='gist', column_name='the_geom')
    op.drop_geospatial_table('state', schema='tiger')
    ...
    op.drop_geospatial_table('tabblock', schema='tiger')
    ...
    op.drop_geospatial_index(op.f('idx_tiger_edges_the_geom_gist'), table_name='edges', schema='tiger', postgresql_using='gist', column_name='the_geom')
    op.drop_geospatial_table('edges', schema='tiger')
    ...
    op.drop_geospatial_table('tabblock20', schema='tiger')
    ...
    op.drop_geospatial_index(op.f('idx_addrfeat_geom_gist'), table_name='addrfeat', schema='tiger', postgresql_using='gist', column_name='the_geom')
    ...
    op.drop_geospatial_table('addrfeat', schema='tiger')
    ...
    op.drop_geospatial_table('bg', schema='tiger')
...
def downgrade() -> None:
    ...
    op.create_geospatial_index(op.f('idx_addrfeat_geom_gist'), 'addrfeat', ['the_geom'], unique=False, schema='tiger', postgresql_using='gist', postgresql_ops={})
    ...
    op.create_geospatial_index(op.f('idx_tiger_edges_the_geom_gist'), 'edges', ['the_geom'], unique=False, schema='tiger', postgresql_using='gist', postgresql_ops={})
    ...
    op.create_geospatial_index(op.f('idx_tiger_state_the_geom_gist'), 'state', ['the_geom'], unique=False, schema='tiger', postgresql_using='gist', postgresql_ops={})
    op.create_table('zip_lookup_base',
    sa.Column('zip', sa.VARCHAR(length=5), autoincrement=False, nullable=False),
    sa.Column('state', sa.VARCHAR(length=40), autoincrement=False, nullable=True),
    sa.Column('county', sa.VARCHAR(length=90), autoincrement=False, nullable=True),
    ...
    op.create_geospatial_index(op.f('tige_cousub_the_geom_gist'), 'cousub', ['the_geom'], unique=False, schema='tiger', postgresql_using='gist', postgresql_ops={})
    op.create_table('pagc_lex',
    sa.Column('id', sa.INTEGER(), autoincrement=True, nullable=False),
    sa.Column('seq', sa.INTEGER(), autoincrement=False, nullable=True),
    sa.Column('word', sa.TEXT(), autoincrement=False, nullable=True),
    ...
    op.create_geospatial_index(op.f('tiger_place_the_geom_gist'), 'place', ['the_geom'], unique=False, schema='tiger', postgresql_using='gist', postgresql_ops={})
    op.create_geospatial_table('faces',
    sa.Column('gid', sa.INTEGER(), autoincrement=True, nullable=False),
    sa.Column('tfid', sa.NUMERIC(precision=10, scale=0), autoincrement=False, nullable=True),
    sa.Column('statefp00', sa.VARCHAR(length=2), autoincrement=False, nullable=True),
    ...
    op.create_geospatial_index(op.f('tiger_faces_the_geom_gist'), 'faces', ['the_geom'], unique=False, schema='tiger', postgresql_using='gist', postgresql_ops={})
